...
public interface HouseRepository extends JpaRepository<House,Integer>{//JpaRepositoryはPagingAndSortingRepositoryを継承しているので、JpaRepositoryを継承するとPageableを引数に取れるようになる。
	...
	public List<House> findTop10ByOrderByCreatedAtDesc();//ページネーションを作らないのでList型で定義している。pageableの引数もいらない
}
