...
public class ReservationService {
	...
	@Transactional
	public void create(Map<String,String> paymentIntentObject) {//StripeService.javaでcreateStripeSession()メソッドが実行されたときに入れられたメタデータを取り出していく
		...
		LocalDate checkinDate = LocalDate.parse(paymentIntentObject.get("checkinDate"));//String をLocalDateにparseしている
